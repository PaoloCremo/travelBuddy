...
def validate_stops(city, interests, duration, pace, weather):
    ...
    Important! Write the explanation before the first colon ':'. After that include ONLY the list of stops as:
    stop1, city, country; stop2, city, country.
    """
...
def format_itinerary(first_draft, stops, city, interests, duration, pace, weather):
    ...
    Format your response following the example below:
